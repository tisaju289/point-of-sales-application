                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 p-1">
                                ...
                                {{-- <label class="form-label mt-3">Company Location *</label> --}}
...
<script>
    ...
    async function FillUpUpdateForm(id){
        ...
        showLoader();
        let res=await axios.post("/id-by-page",{id:id})
        hideLoader();
        document.getElementById('title').value=res.data['title'];
        document.getElementById('content').value=res.data['content'];
        // document.getElementById('company_location').value=res.data['location'];
    }
