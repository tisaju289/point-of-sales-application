...
<nav class="navbar fixed-top px-0 shadow-sm bg-white">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="#">
            ...
            <span href="{{url("/user-dashboard")}}" style="font-size: 20px; font-weight: bold;">JobPulse</span>
            
        </a>

        <div class="float-right h-auto d-flex">
            <div class="user-dropdown">
                <img class="icon-nav-img" src="{{asset('images/tisaju.jpg')}}" alt=""/>
                <div class="user-dropdown-content ">
                    <div class="mt-4 text-center">
                        <img class="icon-nav-img" src="{{asset('images/tisaju.jpg')}}" alt=""/>
                        <h6>Tajul Islam Saju</h6>
...
<div id="sideNavRef" class="side-nav-open">
    ...
    <a href="{{url("/user-auth-home")}}" class="side-bar-item">
