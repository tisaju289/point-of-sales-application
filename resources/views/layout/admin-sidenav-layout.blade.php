...
<nav class="navbar fixed-top px-0 shadow-sm bg-white">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="#">
            ...
            <span href="{{url("/admin-dashboard")}}" style="font-size: 20px; font-weight: bold;">JobPulse</span>
        </a>
        ...
        <div class="float-right h-auto d-flex">
            <div class="user-dropdown">
                ...
                <div class="user-dropdown-content ">
                    ...
                    <a href="{{url('/adminProfile')}}" class="side-bar-item">
...
<div id="sideNavRef" class="side-nav-open">
    ...
    <a href="{{url("/blogPage")}}" class="side-bar-item">
        <i class="bi bi-list-nested"></i>
        <span class="side-bar-item-caption">Blogs</span>
    </a>

    <a href="{{url("/pagePage")}}" class="side-bar-item">
        <i class="bi bi-list-nested"></i>
        <span class="side-bar-item-caption">Pages</span>
    </a>

    <a href="{{url("/AdminpluginPage")}}" class="side-bar-item">
        <i class="bi bi-bag"></i>
